...
# Ensure .env is loaded — works whether running from backend/ or project root
_here = os.path.dirname(os.path.abspath(__file__))
for _candidate in [
    os.path.join(_here, "..", "..", ".env"),       # backend/app/services/ → backend/.env
    os.path.join(_here, "..", "..", "..", ".env"),  # one level deeper fallback
]:
...
class OpenRouterClient:
    def __init__(self, api_key: str = None, model: str = None):
        ...
        self.model   = model   or settings.OPENROUTER_MODEL   or os.getenv("OPENROUTER_MODEL", "nvidia/nemotron-3-super-120b-a12b:free")
